...
*Note: this is a minor change to the SARTools R package to enable the use of 
loess normalization from the csaw package for DESeq2 differential analyses of 
ATAC-seq data. The remainder of the pipeline is unchanged. This modified version 
should be installed via the following command*:
`devtools::install_github("andreamrau/SARTools", build_opts="--no-resave-data")`
